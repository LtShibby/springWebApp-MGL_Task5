package com.MGL_Task4.configuration;
...
@Configuration
@EnableJpaRepositories(basePackages = "com.MGL_Task4.repository", entityManagerFactoryRef = "entityManagerFactory", transactionManagerRef = "transactionManager")
...
public class JpaConfiguration {
	...
	factoryBean.setPackagesToScan(new String[] { "com.MGL_Task4.model" });
